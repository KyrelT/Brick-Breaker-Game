...
public class HomeMenu extends JComponent implements MouseListener, MouseMotionListener {
    ...
    private static final String CREDITS = "Version 6.9";
    private static final String START_TEXT = "Start";
    private static final String MENU_TEXT = "Exit";
    private static final String INFO_TEXT = "Info";

    private static final Color BG_COLOR = new Color(249,164,130);
    ...
    /**
     * @param owner owner
     * @param area the size of the window
     */
    ...
    /**
     * @param g2d setting up the graphics for the game
     */
    ...
    /**
     * @param g2d set up the graphics for the text
     */
    ...
    /**
     * @param g2d set up the graphics for the buttons
     */
    private void drawButton(Graphics2D g2d){
        ...
        int x = (menuFace.width - startButton.width) / 2; //coordinates
